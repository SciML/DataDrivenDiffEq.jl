...
@testset "Train Test Split" begin for r in 0.2:0.2:0.8
    split = Split(ratio = r)
...
@testset "Mini Batching" begin for n in 2:5, repeat_ in [true, false],
...
@testset "DataSampler" begin for repeat_ in [true, false], shuffle_ in [true, false]

...
function select_by(::Val{:kfold}, sol::KoopmanSolution)
    begin
...
# DMD-Like
function CommonSolve.init(prob::AbstractDataDrivenProblem{N, C, P},
...
# All (g(E))DMD like
function CommonSolve.init(prob::AbstractDiscreteProb{N, C}, b::AbstractBasis, alg::A,
...
function CommonSolve.init(prob::AbstracContProb{N, C}, b::AbstractBasis, alg::A, args...;
...
function CommonSolve.solve!(k::KoopmanProblem)
    ...
    return DataDrivenSolution(prob, sol, basis, alg; eval_expression = eval_expression,

...
function CommonSolve.init(
    ...
    x = [Symbolics.variable(:x, i) for i = 1:s_x]
    u = [Symbolics.variable(:u, i) for i = 1:s_u]
...
function CommonSolve.init(
    ...
    kwargs...,
) where {N,C,A<:AbstractKoopmanAlgorithm}
    @is_applicable prob

...
# Dispatch on vector
function (opt::AbstractOptimizer{T} where {T})(X::AbstractArray, A::AbstractArray,
...
function CommonSolve.init(o::AbstractSubspaceOptimizer, A, Y)
...
"""
function init!(X::AbstractArray, o::AbstractOptimizer, A::AbstractArray, Y::AbstractArray)
    begin @static if VERSION < v"1.7.0"

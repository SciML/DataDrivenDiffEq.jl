...
struct InternalDataDrivenProblem{A <: AbstractDataDrivenAlgorithm, B <: AbstractBasis, TD,
    T <: DataLoader, F, CI, VI, PI, SI, O <: DataDrivenCommonOptions,
...
return InternalDataDrivenProblem(alg, test, loader, dt, control_idx, implicit_idx, parameter_idx, state_idx,
